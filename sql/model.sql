...
create table project_types(
  ...
  project_type_added_at TIMESTAMP WITH TIME ZONE
  default CURRENT_TIMESTAMP
);
...
CREATE TABLE projects(
  ...
  project_added_at TIMESTAMP WITH TIME ZONE
  default CURRENT_TIMESTAMP
);

comment on table projects is 'Team'
's completed projects list';
...
CREATE TABLE professions(
  ...
  profession_added_at TIMESTAMP WITH TIME ZONE
  default CURRENT_TIMESTAMP
);
...
CREATE TABLE members(
  ...
  member_added_at TIMESTAMP WITH TIME ZONE
  default CURRENT_TIMESTAMP
);

comment on table members is 'Our team'
's members';
...
CREATE TABLE services(
  ...
  default true,
  service_added_at TIMESTAMP WITH TIME ZONE
  default CURRENT_TIMESTAMP
);
...
create TABLE technology_type(
  technology_type_id INT GENERATED BY
  default as identity PRIMARY KEY,
...
--CREATE TABLE blogs(
  ...
  --blog_created_at TIMESTAMP WITH TIME ZONE
  default CURRENT_TIMESTAMP
  --);
...
create table features (
  ...
  feature_title_uz varchar(72) NOT NULL,
  feature_description_uz varchar(128) NOT NULL,

  feature_title_ru varchar(72) NOT NULL,
  feature_description_ru varchar(128) NOT NULL,

  feature_title_en varchar(72) NOT NULL,
  feature_description_en varchar(128) NOT NULL,

  feature_image_src VARCHAR(128) NOT NULL,
  project_id INT NOT NULL REFERENCES projects(project_id),
  feature_created_at TIMESTAMP WITH TIME ZONE
  default CURRENT_TIMESTAMP
);
comment on table users is 'Table for features';