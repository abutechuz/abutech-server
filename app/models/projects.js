...
const insertProject = async ({
  ...
  }, project_image, project_old_img_src,
  project_new_img_src) => {
  ...
  return await fetchOne(SQL,
    ...
    JSON.parse(project_challenges_uz),
    JSON.parse(project_challenges_ru),
    JSON.parse(project_challenges_en),
